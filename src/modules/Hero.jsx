...
export default function Hero() {
  ...
  return (
    <section className="flex items-center justify-center flex-col w-screen h-screen bg-background text-textColor-500 p-8 object-cover">
      <img src={iconGradient} className="absolute top-0 left-0 w-[20vw] sm:w-[10vw] md:w-[15vw] z-5" />
      ...
      <Search />
      <img src={iconGradient} className="absolute bottom-0 right-0 w-[20vw] sm:w-[10vw] md:w-[15vw] rotate-180" />
    </section>
  )
}