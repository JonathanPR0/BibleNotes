...
export default function GridNotes({ setShowForm, setShowNote, setIsActive, isActive }) {
  return (
    <section className={`${isActive ? "flex md:grid" : "hidden"} flex-col justify-center md:grid-cols-2 auto-rows-auto gap-8 sm:gap-12 max-w-5xl px-8 py-16 bg-white w-screen `}>
